...
{
    public partial class Consultar_barberia : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack) {
                ...
                listview1.DataSource = bar.consult_barberia();
                listview1.DataBind();
            }
        ...
        public void Unnamed_Command(object sender, CommandEventArgs e)
        {
            if (e.CommandName.Equals("eliminar"))
            {
                ...
                if (obj.cambiar_estado_barberia(idbareria) == true)
                {
                    ...
                    Response.Redirect("../Administrador/Consultar_barberia.aspx");
