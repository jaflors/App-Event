<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Administrador/Administrador.Master" AutoEventWireup="true" CodeBehind="Actualizar_Cita.aspx.cs" Inherits="Admin.Views.Administrador.Actualizar_Cita" %>
                    ...
                    <form runat="server" data-parsley-validate class="form-horizontal form-label-left">
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <asp:DropDownList ID="List_cliente" class="form-control" runat="server" required="required"></asp:DropDownList>

                            </div>
                            <label id="label_client" runat="server" class="alert-info col-md-2 col-sm-2 col-xs-12" for="first-name">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                ...
                                <a href="Consultar_Cita.aspx" class="btn btn-primary">Volver</a>
                            </div>
                        </div>
