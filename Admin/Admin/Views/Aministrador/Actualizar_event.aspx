<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Aministrador/Administrador.Master" AutoEventWireup="true" CodeBehind="Actualizar_event.aspx.cs" Inherits="Admin.Views.Aministrador.Actualizar_event" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Actualizar Evento <small>Session</small></h2>
                      ...
                      <form runat="server" class="form-horizontal form-label-left">
                          ...
                          <div class="form-group">
                              ...
                              <label class="control-label col-md-3 col-sm-3 col-xs-12">
                                Seleccione evento<span <%--class="required"--%>>*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <asp:DropDownList ID="List_eventos" class="form-control" runat="server" OnSelectedIndexChanged="List_eventos_SelectedIndexChanged" AutoPostBack="true"  ></asp:DropDownList>
                                 <%--<asp:ListBox ID="List_eventos" runat="server" CssClass="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input type="date" runat="server" id="fecha"  class ="form-control" />
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                <asp:Button ID="Button1" class="btn btn-success" runat="server" OnClick="Actualizar" Text="Actualizar" />
