<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Aministrador/Administrador.Master" AutoEventWireup="true" CodeBehind="Actualizar_perfil.aspx.cs" Inherits="Admin.Views.Participante.Actualizar_perfil" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Actualiza tu perfil <small>Session</small></h2>
                    ...
                    <form runat="server" class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                          <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                              ...
                              <asp:button id="Button_Actualizar" runat="server" onclick="Actualizar" class="btn btn-success" text="Actualizar" />
                          </div>
                      </div>
