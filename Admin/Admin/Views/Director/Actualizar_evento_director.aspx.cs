...
{
    public partial class Actualizar_evento_director : System.Web.UI.Page
    {
        ...
        public void cargarEventos()
        {
            ...
            dtevent = obj2.consultar_eventos_Director(Session["login"].ToString());
        ...
        protected void List_eventos_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Session["nombre_event"] = dtevent.Rows[index]["Nombre"].ToString();
        ...
        protected void Actualizar(object sender, EventArgs e)
        {
            ...
            for (int i =0;i< dtinscritos.Rows.Count; i++)
            {
                ...
                Correo objcorreo = new Correo(drconsulta["correo"].ToString(), "Cambio de fechas Evento", "Se cambiaron las fechas del evento '"+ Session["nombre_event"].ToString() + "' a  '"+ fecha.Value.ToString() + "'- '" + fecha2.Text + "'      ");
             }
