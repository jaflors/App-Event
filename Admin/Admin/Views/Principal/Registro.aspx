<%@ Page Title="Registro" Language="C#" MasterPageFile="~/Views/Principal/Principal.Master" AutoEventWireup="true" CodeBehind="Registro.aspx.cs" Inherits="Admin.Views.Principal.Registro" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="image-container set-full-height" style="background-image: url('../../lesser/images/mural.jpg')">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4 col-sm-offset-1">
                                                <div class="picture-container">
                                                    <div class="picture">
                                                        <img src="../../registro/assets/img/default-avatar.png" class="picture-src" id="wizardPicturePreview" title="" />
                                                        
                                                        <asp:FileUpload ID="file_usuario" runat="server" required="required" />
                                                    </div>
