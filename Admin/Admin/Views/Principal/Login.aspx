<%@ Page Title="Login" Language="C#" MasterPageFile="~/Views/Principal/Principal.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Admin.Views.Principal.Login" %>
                ...
                <div class="col-sm-8 col-sm-offset-2">
                    <div class="wizard-container">
                            ...
                            <form class="login" runat="server" name="login">
                                ...
                                <img src="../../lesser/images/icono.png" />
